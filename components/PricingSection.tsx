  ...
  return (
    <div id="pricing" className="relative isolate px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mt-2 text-5xl font-semibold tracking-tight text-balance opacity-90 sm:text-6xl">
          Choose the right plan for you
        </p>
      </div>
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty opacity-60 sm:text-xl/8">
        ...
        {tiers.map((tier, tierIdx) => (
          ...
          >
            ...
            <p className="mt-4 flex items-baseline gap-x-2">
              ...
              <span className={classNames(tier.featured ? 'text-gray-400' : 'opacity-50', 'text-base')}>/month</span>
            </p>
