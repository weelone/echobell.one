...
[Echobell Direct](/es/docs/direct) te da un webhook personal sin necesidad de configurar un canal completo. Añade una llamada al final de cualquier script:
...
Si trabajas con Claude u otros agentes IA via [WebhookMCP](/es/blog/get-notified-with-webhook-mcp), el propio agente puede disparar la notificación cuando completa una tarea. Lanzas el trabajo, te pones a hacer otra cosa, y el teléfono vibra cuando termina.
...
Con la función de [Condiciones](/es/docs/conditions) puedes añadir lógica a nivel de entrega: por ejemplo, llamar solo fuera del horario laboral, o alertar solo cuando un valor supera un umbral.
...
- [Echobell Direct — webhooks personales sin configurar canal](/es/docs/direct)
- [Notificaciones Zapier webhook al teléfono](/es/blog/zapier-webhook-notifications-to-phone)
- [Notificaciones de llamada de Grafana](/es/blog/grafana-call-notification)
- [Alertas de llamada de TradingView](/es/blog/tradingview-call-notifications)
- [Notificaciones de Home Assistant con Echobell](/es/blog/home-assistant-notifications-with-echobell)
- [Hub de automatización con n8n y Echobell](/es/blog/n8n-echobell-automation-hub)
- [WebhookMCP — recibe notificaciones cuando terminan las tareas IA](/es/blog/get-notified-with-webhook-mcp)
