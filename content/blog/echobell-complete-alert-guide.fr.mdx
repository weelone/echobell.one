...
[Echobell Direct](/fr/docs/direct) te donne un webhook personnel sans avoir à configurer un canal complet. Ajoute un appel à la fin de n'importe quel script :
...
Si tu travailles avec Claude ou d'autres agents IA via [WebhookMCP](/fr/blog/get-notified-with-webhook-mcp), l'agent lui-même peut déclencher la notification quand la tâche est terminée. Tu lances le job, tu fais autre chose, le téléphone vibre quand c'est fini.
...
La fonction [Conditions](/fr/docs/conditions) te permet d'ajouter de la logique au niveau de la livraison : par exemple, appeler seulement en dehors des heures de travail, ou alerter seulement quand une valeur dépasse un seuil.
...
- [Echobell Direct — webhooks personnels sans configuration de canal](/fr/docs/direct)
- [Notifications Zapier webhook sur téléphone](/fr/blog/zapier-webhook-notifications-to-phone)
- [Notifications d'appel Grafana](/fr/blog/grafana-call-notification)
- [Alertes d'appel TradingView](/fr/blog/tradingview-call-notifications)
- [Notifications Home Assistant avec Echobell](/fr/blog/home-assistant-notifications-with-echobell)
- [Hub d'automatisation avec n8n et Echobell](/fr/blog/n8n-echobell-automation-hub)
- [WebhookMCP — être notifié quand les tâches IA se terminent](/fr/blog/get-notified-with-webhook-mcp)
