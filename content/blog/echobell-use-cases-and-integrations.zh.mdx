...
跑着长时间的 AI 任务、批量处理，或者其他需要几分钟以上的任务？与其盯着终端，不如用 [Echobell Direct](/zh/docs/direct) 在任务完成时通知你。
...
如果你在用 Claude 或其他 AI 智能体，这和 [WebhookMCP](/zh/blog/get-notified-with-webhook-mcp) 搭配很顺手——智能体完成长任务时可以自动触发 Echobell 通知。
...
- [用 Upptime 和 Echobell 做可用性监控](/zh/blog/upptime-alerts-with-echobell)
- [Grafana 来电通知](/zh/blog/grafana-call-notification)
- [API 宕机时的来电提醒](/zh/blog/phone-call-alerts-api-downtime)
