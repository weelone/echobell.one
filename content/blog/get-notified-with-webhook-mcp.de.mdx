...
1. [Echobell](https://apps.apple.com/app/apple-store/id6743597198?pt=128151925&ct=blog-get-notified-with-webhook-mcp-de&mt=8) / [Google Play](https://play.google.com/store/apps/details?id=one.echobell.echobellandroid) öffnen und einen Channel erstellen (z. B. „KI-Aufgaben")
...
Zu verwandten Integrationen siehe [GitHub Actions-Benachrichtigungen](/de/blog/github-actions-notifications) und die [Webhook-Dokumentation](/de/docs/webhook).
