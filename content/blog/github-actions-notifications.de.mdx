...
1. [Echobell herunterladen](https://apps.apple.com/app/apple-store/id6743597198?pt=128151925&ct=blog-github-actions-notifications-de&mt=8) / [Google Play](https://play.google.com/store/apps/details?id=one.echobell.echobellandroid) und anmelden
...
**Separate Channels nach Schweregrad.** Standard-Channel für normale CI-Alarme, zweiter Channel auf **Anruf** für Produktionsfehler. Verschiedene Workflows zeigen auf verschiedene Webhook-URLs. Details zu Anruf-Benachrichtigungen: [Anruf-Benachrichtigungen](/de/blog/grafana-call-notification).

**Channels mit dem Team teilen.** Einen Channel für CI/CD-Fehler erstellen, die das gesamte Team sehen soll, und einen separaten für Infrastruktur-Probleme. Echobells [geteilte Channels](/de/features/channels) ermöglichen es Teammitgliedern, mit eigenen Benachrichtigungseinstellungen zu abonnieren – ohne individuelle Webhook-Konfiguration.

## Verwandte Ressourcen

- [Webhook-Dokumentation](/de/docs/webhook) — vollständige Webhook-API-Referenz
- [Templates](/de/docs/template) und [Bedingungen](/de/docs/conditions) — Benachrichtigungsinhalte und Filterung anpassen
- [Grafana Anruf-Benachrichtigungen](/de/blog/grafana-call-notification) — Telefonanrufe für Monitoring-Systeme
- [WebhookMCP-Benachrichtigungen](/de/blog/get-notified-with-webhook-mcp) — Alarme bei KI-Aufgaben-Abschluss
- Feature-Dokumentation: [Channels](/de/features/channels), [Webhooks](/de/features/webhooks), [E-Mail-Trigger](/de/features/email-triggers), [Anruf-Benachrichtigungen](/de/features/call-notifications)
