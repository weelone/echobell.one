...
1. [Descarga Echobell](https://apps.apple.com/app/apple-store/id6743597198?pt=128151925&ct=blog-github-actions-notifications-es&mt=8) / [Google Play](https://play.google.com/store/apps/details?id=one.echobell.echobellandroid) e inicia sesión
...
**Usa canales separados por severidad.** Mantén un canal estándar para alertas de CI normales y un segundo canal configurado como **Calling** para fallos en producción. Apunta diferentes workflows a diferentes URLs de webhook. Consulta las [notificaciones de llamada](/es/blog/grafana-call-notification) para más detalles.

**Comparte canales con tu equipo.** Crea un canal para los fallos de CI/CD que todo el equipo deba ver, y uno separado para problemas de infraestructura. Los [canales compartidos](/es/features/channels) de Echobell permiten que los compañeros se suscriban con sus propias preferencias de notificación — sin que todos tengan que configurar webhooks individualmente.

## Relacionados

- [Documentación de webhook](/es/docs/webhook) — referencia completa de la API de webhook
- [Plantillas](/es/docs/template) y [Condiciones](/es/docs/conditions) — personaliza el contenido y el filtrado de notificaciones
- [Notificaciones de llamada de Grafana](/es/blog/grafana-call-notification) — alertas por llamada para sistemas de monitoreo
- [Notificaciones de WebhookMCP](/es/blog/get-notified-with-webhook-mcp) — alertas para la finalización de tareas de IA
- Documentación de funciones: [Canales](/es/features/channels), [Webhooks](/es/features/webhooks), [Disparadores de correo](/es/features/email-triggers), [Notificaciones de llamada](/es/features/call-notifications)
