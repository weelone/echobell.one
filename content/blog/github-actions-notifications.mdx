...
**Pro tip**: If you're managing multiple projects, create separate Echobell channels for each one. This way, you'll immediately know which project is having issues without digging into details. Learn more about [organizing your notification channels](/features/channels) and [webhooks](/features/webhooks).
...
- **Monitoring Integration**: If you're using Grafana for system monitoring, you can set up [phone call alerts for critical system failures](/blog/grafana-call-notification) using the same webhook approach.

- **AI Development Workflows**: Working with long-running AI tasks? Check out how to [get notified when your AI tasks complete](/blog/get-notified-with-webhook-mcp) using WebhookMCP integration.

- **Custom Application Alerts**: Beyond CI/CD, you can integrate Echobell's webhooks directly into your applications for user-facing notifications, system health alerts, or business event triggers. The [webhook integration guide](/docs/webhook) covers all the technical details.
...
4. Explore additional integrations like [webhook monitoring](/docs/webhook) and [email triggers](/features/email-triggers)

For detailed setup instructions and advanced configuration options, see the [developer guide](/docs/developer) and the [getting started docs](/docs). You may also find templates and expressions helpful: [Templates](/docs/template) and [Conditions](/docs/conditions).
...
- Webhooks 101: [Triggering notifications with Echobell webhooks](/docs/webhook)
- Feature deep dive: [Channels](/features/channels), [Webhooks](/features/webhooks), [Email triggers](/features/email-triggers), [Templates](/features/templates), [Call notifications](/features/call-notifications)
- Blog guides: [Grafana call notifications](/blog/grafana-call-notification), [Get notified from WebhookMCP](/blog/get-notified-with-webhook-mcp), [Email to call notification](/blog/email-to-call-notification)
