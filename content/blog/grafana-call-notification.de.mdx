...
- Benachrichtigungstypen und Wiederholungen → [/docs/notification](/de/docs/notification)
- Webhooks-Übersicht → [/docs/webhook](/de/docs/webhook)
- Grafana-Integrationsreferenz → [/docs/developer/grafana](/de/docs/developer/grafana)

## Voraussetzungen

1. Echobell-Konto mit aktivem Channel und Webhook-URL (siehe [/docs/webhook](/de/docs/webhook))
...
Diese URL finden Sie in Ihren Channel-Einstellungen in Echobell (Details unter [/docs/webhook](/de/docs/webhook)). Behandeln Sie sie wie ein Secret und rotieren Sie sie bei Bedarf.
...
- In Echobell Wiederholungen und Timeouts konfigurieren, um Alarm-Fatigue zu reduzieren ([/docs/notification](/de/docs/notification))
...
Vollständige Referenz: [/docs/developer/grafana](/de/docs/developer/grafana)
...
- GitHub Actions-Fehlerbenachrichtigungen → [/blog/github-actions-notifications](/de/blog/github-actions-notifications)
- Grafana-Entwicklerdokumentation → [/docs/developer/grafana](/de/docs/developer/grafana)
