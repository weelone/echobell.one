...
- Types de notifications et tentatives automatiques → [/docs/notification](/fr/docs/notification)
- Présentation des Webhooks → [/docs/webhook](/fr/docs/webhook)
- Référence d'intégration Grafana → [/docs/developer/grafana](/fr/docs/developer/grafana)

## Prérequis

1. Compte Echobell avec un canal actif et une URL Webhook (voir [/docs/webhook](/fr/docs/webhook))
...
Copiez-la depuis les paramètres du canal dans Echobell (détails sur [/docs/webhook](/fr/docs/webhook)). Traitez-la comme un secret et faites une rotation en cas de fuite.
...
- Configurez les tentatives automatiques et les délais d'expiration dans Echobell pour limiter la fatigue des alertes ([/docs/notification](/fr/docs/notification))
...
Référence complète : [/docs/developer/grafana](/fr/docs/developer/grafana)
...
- Notifications d'échec GitHub Actions → [/blog/github-actions-notifications](/fr/blog/github-actions-notifications)
- Documentation développeur Grafana → [/docs/developer/grafana](/fr/docs/developer/grafana)
