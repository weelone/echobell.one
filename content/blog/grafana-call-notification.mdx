...
# Enable Phone Call Notifications for Grafana Alerts
...
2. **Configure the Webhook**
   ...
   - Set the URL to: `https://api.echobell.one/v1/grafana/call`
   - Add your Echobell API key as a Custom Header:
     ```
     Header: X-API-Key
     Value: your-echobell-api-key
     ```
...
- Setting up call cascades for team escalation
