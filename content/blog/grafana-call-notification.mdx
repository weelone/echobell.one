...
- Notifications model (priorities, retries) → [/docs/notification](/en/docs/notification)
- Webhooks overview → [/docs/webhook](/en/docs/webhook)
- Grafana developer guide → [/docs/developer/grafana](/en/docs/developer/grafana)
...
You can copy this from your channel settings in Echobell (details in [/docs/webhook](/en/docs/webhook)). Treat it like a secret and rotate it if leaked.
...
- In Echobell, set retries and timeouts to avoid alert fatigue (see [/docs/notification](/en/docs/notification))
...
See the full Grafana integration guide here: [/docs/developer/grafana](/en/docs/developer/grafana)
...
- How to send webhook alerts to Echobell (great for custom systems): [/blog/get-notified-with-webhook-mcp](/en/blog/get-notified-with-webhook-mcp)
- GitHub Actions failures, instantly on your phone: [/blog/github-actions-notifications](/en/blog/github-actions-notifications)
- Developer docs for Grafana: [/docs/developer/grafana](/en/docs/developer/grafana)
