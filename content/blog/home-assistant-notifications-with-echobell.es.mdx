...
1. [Descarga Echobell](https://apps.apple.com/app/apple-store/id6743597198?pt=128151925&ct=blog-home-assistant-notifications-1ozbir&mt=8) / [Google Play](https://play.google.com/store/apps/details?id=one.echobell.echobellandroid) y crea un canal (p. ej., "Home Alerts")
...
Envía variables de contexto con el webhook, luego usa las [condiciones de Echobell](/es/docs/conditions) para filtrar en el canal:
...
Para documentación técnica completa, incluyendo plantillas avanzadas y solución de problemas, consulta la [guía de integración con Home Assistant](/es/docs/developer/home-assistant). Para otras integraciones, consulta [notificaciones de GitHub Actions](/es/blog/github-actions-notifications) y [alertas de monitoreo de Grafana](/es/blog/grafana-call-notification).
