...
Webhookで状況変数を送り、[Echobellの条件](/ja/docs/conditions)を使ってチャンネル側でフィルタリング:
...
高度なテンプレートとトラブルシューティングを含む技術ドキュメントの詳細は[Home Assistantインテグレーションガイド](/ja/docs/developer/home-assistant)を参照してください。その他のインテグレーションについては[GitHub Actions通知](/ja/blog/github-actions-notifications)と[Grafana監視アラート](/ja/blog/grafana-call-notification)をご覧ください。
