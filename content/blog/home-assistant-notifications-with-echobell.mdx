...
I used to have my security sensors send me every single motion detection event. This resulted in alert fatigue—I'd see so many notifications that I started ignoring them all. Now I use [Echobell conditions](/en/docs/conditions) to be smarter about what constitutes a real security event:
...
For detailed technical documentation including advanced templating, conditions, and troubleshooting, check out the [complete Home Assistant integration guide](/en/docs/developer/home-assistant).

And if you're curious about other ways to use Echobell beyond home automation, we've got guides for everything from [GitHub Actions notifications](/en/blog/github-actions-notifications) to [Grafana monitoring alerts](/en/blog/grafana-call-notification). The webhook-based approach is surprisingly versatile.
