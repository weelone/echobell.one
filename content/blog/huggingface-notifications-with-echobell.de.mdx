...
Für bedingte Filterung (z. B. nur bei `update`-Ereignissen für bestimmte Repositories) [Echobell-Bedingungen](/de/docs/conditions) nutzen:
...
Webhook-Konfigurationsreferenz: [Echobell-Webhook-Dokumentation](/de/docs/webhook). Verwandte Integrationen: [GitHub Actions-Benachrichtigungen](/de/blog/github-actions-notifications) und [Grafana-Alarme](/de/docs/developer/grafana).
