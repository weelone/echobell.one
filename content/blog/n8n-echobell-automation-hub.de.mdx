...
Kritische Home Assistant-Ereignisse (Wasserlecksensoren, Rauchmelder, Tür-/Fenstersensoren bei Abwesenheit) über n8n an Echobell weiterleiten. Details: [Home Assistant-Integrationsanleitung](/de/blog/home-assistant-notifications-with-echobell).
...
Echobells [Bedingungen](/de/docs/conditions) ermöglichen Filterung auf Zustellungsebene:
...
Mit einem Workflow starten, dann ausbauen. Die [Webhook-Dokumentation](/de/docs/webhook) deckt die vollständige Echobell-API ab.
