...
n8n gestiona bien la automatización de flujos de trabajo, pero sus notificaciones integradas son limitadas. Combinarlo con [Echobell](https://apps.apple.com/app/apple-store/id6743597198?pt=128151925&ct=blog-n8n-echobell-automation-hub-es&mt=8) / [Google Play](https://play.google.com/store/apps/details?id=one.echobell.echobellandroid) cubre esa brecha: n8n se encarga de la lógica, Echobell entrega alertas push o llamadas que realmente llegan a ti.
...
Reenvía eventos críticos de Home Assistant (sensores de fuga de agua, detectores de humo, sensores de puertas/ventanas cuando estás fuera) via n8n a Echobell. Consulta la [guía de integración con Home Assistant](/es/blog/home-assistant-notifications-with-echobell) para más detalles.
...
La función de [Condiciones](/es/docs/conditions) de Echobell te permite filtrar en la capa de entrega:
...
Empieza con un flujo de trabajo y construye a partir de ahí. La [documentación de webhook](/es/docs/webhook) cubre la API completa de Echobell.
