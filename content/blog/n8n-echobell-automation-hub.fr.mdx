...
n8n gère bien l'automatisation des workflows, mais ses notifications intégrées sont limitées. L'associer à [Echobell](https://apps.apple.com/app/apple-store/id6743597198?pt=128151925&ct=blog-n8n-echobell-automation-hub-fr&mt=8) / [Google Play](https://play.google.com/store/apps/details?id=one.echobell.echobellandroid) comble ce manque : n8n s'occupe de la logique, Echobell délivre des alertes push ou des appels téléphoniques qui vous atteignent réellement.
...
Transférez les événements critiques de Home Assistant (capteurs de fuite d'eau, détecteurs de fumée, capteurs de porte/fenêtre en cas d'absence) via n8n vers Echobell. Voir le [guide d'intégration Home Assistant](/fr/blog/home-assistant-notifications-with-echobell) pour les détails.
...
La fonctionnalité [Conditions](/fr/docs/conditions) d'Echobell vous permet de filtrer au niveau de la livraison :
...
Commencez avec un workflow, puis développez à partir de là. La [documentation Webhook](/fr/docs/webhook) couvre l'API Echobell complète.
