...
- QQ Mail setup doc: [/docs/email-to-call/qq](/en/docs/email-to-call/qq)
- Email trigger basics: [/docs/email-trigger](/en/docs/email-trigger)
- Notification types (including Calling): [/docs/notification](/en/docs/notification)
- Templates and variables: [/docs/template](/en/docs/template)
- Optional fallback conditions: [/docs/conditions](/en/docs/conditions)
...
Related: [/docs/notification](/en/docs/notification)
...
You can customize variables and formatting here: [/docs/template](/en/docs/template)
...
If you want the full QQ-specific walkthrough, use: [/docs/email-to-call/qq](/en/docs/email-to-call/qq)
...
Condition reference: [/docs/conditions](/en/docs/conditions)
...
More email-trigger integrations: [/docs/email-to-call](/en/docs/email-to-call)
