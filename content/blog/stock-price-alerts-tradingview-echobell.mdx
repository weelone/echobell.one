...
2. Pick a notification type. For urgent moves choose **Calling**; otherwise **Time Sensitive**. See [/docs/notification](/en/docs/notification).
...
4. Copy the channel’s Webhook URL (keep it private). Details: [/docs/webhook](/en/docs/webhook)
...
- `externalLink` is optional; Echobell will show it in the local record. See [/docs/notification](/en/docs/notification).
...
Further reading: TradingView calls → [/blog/tradingview-call-notifications](/en/blog/tradingview-call-notifications). Features: [/features/webhooks](/en/features/webhooks), [/features/call-notifications](/en/features/call-notifications).
