...
Voraussetzungen: [Bedingungen](/de/docs/conditions), [Templates](/de/docs/template), [Webhook](/de/docs/webhook), [E-Mail-Trigger](/de/docs/email-trigger).
...
In [Bedingungen](/de/docs/conditions) direkt verwenden (ohne `{{ }}`). In [Templates](/de/docs/template) mit `{{ }}`.
...
Bedingungen sind einfache Ausdrücke – kein `{{ }}`-Wrap. Siehe [Bedingungen → Unterstützte Operatoren](/de/docs/conditions#supported-operators).
...
Mit Daten aus [Webhook](/de/docs/webhook) oder [E-Mail-Trigger](/de/docs/email-trigger) kombinieren:
...
- Zeitfenster-Bedingung zu einem bestehenden Channel hinzufügen: [Bedingungen](/de/docs/conditions)
- Benachrichtigungsinhalt mit Variablen anpassen: [Templates](/de/docs/template)
