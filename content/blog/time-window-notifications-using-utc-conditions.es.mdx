...
Requisitos previos: [Condiciones](/es/docs/conditions), [Plantillas](/es/docs/template), [Webhook](/es/docs/webhook), [Disparadores de correo](/es/docs/email-trigger).
...
Úsalas directamente en [Condiciones](/es/docs/conditions) (sin `{{ }}`). Úsalas con `{{ }}` en [Plantillas](/es/docs/template).
...
Las condiciones son expresiones simples — no las envuelvas en `{{ }}`. Consulta [Condiciones → Operadores admitidos](/es/docs/conditions#supported-operators).
...
Combínalas con datos de [Webhook](/es/docs/webhook) o [Disparadores de correo](/es/docs/email-trigger):
...
- Agrega una condición de ventana de tiempo a un canal existente: [Condiciones](/es/docs/conditions)
- Personaliza el contenido de las notificaciones con variables: [Plantillas](/es/docs/template)
