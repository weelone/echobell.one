...
Eine vollständige Anleitung finden Sie im [Upptime-Konfigurationsleitfaden](/de/docs/developer/upptime). Für Upptime-eigene Benachrichtigungsoptionen lesen Sie die [offizielle Dokumentation](https://upptime.js.org/docs/notifications).
