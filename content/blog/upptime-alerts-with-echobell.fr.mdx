...
Pour un guide complet, voir le [guide de configuration Upptime](/fr/docs/developer/upptime). Pour les options de notification d'Upptime, consultez la [documentation officielle](https://upptime.js.org/docs/notifications).
