...
That’s it—Upptime delivers the data, and Echobell handles the notification style. If you need the full breakdown, the [configuration guide](/en/docs/developer/upptime) walks through every detail, while Upptime’s own knobs stay in the [official docs](https://upptime.js.org/docs/notifications).
