...
2. **Umgang mit dem Secret**: App Store Connect verlangt ein Secret, Echobell prüft es jedoch derzeit nicht automatisch. Bewahren Sie den Wert auf, falls Sie Payloads bei Bedarf manuell prüfen möchten.
