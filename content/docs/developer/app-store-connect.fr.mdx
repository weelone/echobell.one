...
2. **Gestion du secret** : App Store Connect exige un secret, mais Echobell ne le vérifie pas automatiquement. Conservez-le pour pouvoir contrôler les charges utiles manuellement si nécessaire.
