---
title: "GitHub Integration - Repo Events & CI/CD Alerts"
sidebarTitle: GitHub
description: Set up GitHub webhooks with Echobell to get instant mobile alerts for pull requests, issues, releases, and failed CI/CD workflow runs.
---
