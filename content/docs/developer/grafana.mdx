---
title: "Grafana Integration - Infrastructure Alerts"
sidebarTitle: Grafana
description: Send Grafana alerts to Echobell via webhook and get instant push notifications or phone calls. Step-by-step setup with alert templates.
---
...
- **Use emoji sparingly** - 🚨 for critical, ⚠️ for warnings, ✅ for resolved
