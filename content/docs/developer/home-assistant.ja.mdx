---
title: Home Assistant 連携 - スマートホームオートメーションアラート & IoT通知
sidebarTitle: Home Assistant
description: EchobellとHome Assistantを統合してスマートホームの即時通知を受け取るための完全ガイド。セキュリティシステム、温度センサー、モーション検知、ドアロック、オートメーショントリガーのプッシュ通知または電話通知を設定。
---
...
- モバイル端末に [Echobell アプリ](https://apps.apple.com/app/apple-store/id6743597198?pt=128151925&ct=docs-developer-home-assistant-ja&mt=8) / [Google Play](https://play.google.com/store/apps/details?id=one.echobell.echobellandroid) がインストールされていること
...
4. URL をコピーします。次のようになります：`https://hook.echobell.one/t/<channel-token>`
</Step>
<Step>
