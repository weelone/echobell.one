...
- 移动设备上已安装 [Echobell 应用](https://apps.apple.com/app/apple-store/id6743597198?pt=128151925&ct=docs-developer-home-assistant-zh&mt=8) / [Google Play](https://play.google.com/store/apps/details?id=one.echobell.echobellandroid)
...
4. 复制 URL，格式类似：`https://hook.echobell.one/t/<channel-token>`
</Step>
<Step>
