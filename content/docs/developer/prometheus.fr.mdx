...
description: Configurez Alertmanager pour envoyer des alertes à Echobell via webhook ou email
---
...
- [Règles d'alerte](https://prometheus.io/docs/alerting/latest/alerting_rules/)
- [Webhook Echobell](/fr/docs/webhook)
- [Modèles](/fr/docs/notification)
