---
title: "Prometheus Alertmanager Integration - Mobile Alerts"
sidebarTitle: Prometheus
description: Route Prometheus Alertmanager alerts to Echobell and get push notifications or phone calls for server and infrastructure incidents.
---
