---
title: "UptimeRobot Integration - Downtime Alerts"
sidebarTitle: UptimeRobot
description: Send UptimeRobot alerts to Echobell for push or phone call notifications on downtime, SSL expiry, and slow response times.
---
