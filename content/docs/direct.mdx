...
sidebarTitle: Direct
description: Send notifications directly with a personal API key - no channel setup. Create Direct keys and trigger instant alerts with title, body, and links.
---
