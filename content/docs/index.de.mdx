...
1. Laden Sie Echobell aus dem [App Store](https://apps.apple.com/app/apple-store/id6743597198?pt=128151925&ct=docs-index-de&mt=8) / [Google Play](https://play.google.com/store/apps/details?id=one.echobell.echobellandroid) herunter
...
curl -X GET "https://hook.echobell.one/t/<channel-token>?server=production&status=critical&message=CPU-Auslastung%20bei%2095%25"
