...
1. Téléchargez Echobell depuis l'[App Store](https://apps.apple.com/app/apple-store/id6743597198?pt=128151925&ct=docs-index-fr&mt=8) / [Google Play](https://play.google.com/store/apps/details?id=one.echobell.echobellandroid)
...
curl -X GET "https://hook.echobell.one/t/<channel-token>?server=production&status=critical&message=Utilisation%20CPU%20à%2095%25"
