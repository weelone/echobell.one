---
title: "Notification Types - Push, Time-Sensitive & Calls"
sidebarTitle: Notifications
description: "Compare Echobell notification types: normal push, time-sensitive alerts that break through Focus Mode, and phone call alerts for critical events."
---
...
- Query parameters: `https://hook.echobell.one/t/<channel-token>?server=production&status=critical`
- JSON body:
