---
title: "TradingView Integration - Trading Alerts & Calls"
sidebarTitle: "TradingView"
description: Send TradingView alerts to Echobell via webhook and get push notifications or phone calls for price and strategy signals.
---
