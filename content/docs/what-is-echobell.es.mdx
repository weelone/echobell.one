...
```http
GET https://hook.echobell.one/t/<channel-token>?server_name=Produccion&cpu_usage=95
...
1. **Descarga** la aplicación Echobell desde la [App Store](https://apps.apple.com/app/apple-store/id6743597198?pt=128151925&ct=docs-what-is-echobell-es&mt=8) (iOS 15.0 o posterior) o [Google Play](https://play.google.com/store/apps/details?id=one.echobell.echobellandroid)
