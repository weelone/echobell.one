...
1. **Download** the Echobell app from [App Store](https://apps.apple.com/app/apple-store/id6743597198?pt=128151925&ct=docs-what-is-echobell-en&mt=8) (iOS 15.0 or later) or [Google Play](https://play.google.com/store/apps/details?id=one.echobell.echobellandroid)
...
<Callout type="warn">
  ...
  features are notification-based. You'll be prompted to grant this permission
