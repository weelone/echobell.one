...
1. Download Echobell app from App Store
...
<Callout type="warn">Echobell requires notification permission to function properly, as all features are notification-based.</Callout>