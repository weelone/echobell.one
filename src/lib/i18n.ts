const appStoreImageEn = "/images/app-store.en.svg";
const appStoreImageZh = "/images/app-store.zh.svg";
...
/**
 * Hero titles are structured data instead of JSX: string segments render as
 * plain text, `{ cover: ... }` segments render inside the <Cover> effect.
 */
export type HeroTitleSegment = string | { cover: string };
...
export const uiDictionary = {
  en: {
    ...
    hero: {
      ...
      title: [{ cover: "Instant Alerts" }, " for Critical Events."] as HeroTitleSegment[],
  ...
  zh: {
    ...
    hero: {
      ...
      title: ["关键事件", { cover: "即时警报" }, "。"] as HeroTitleSegment[],
  ...
  es: {
    ...
    hero: {
      // Smoothness
      title: [{ cover: "Alertas Instantáneas" }, " para Eventos Críticos."] as HeroTitleSegment[],
      // Smoothness
      description:
  ...
  fr: {
    ...
    hero: {
      // Smoothness
      title: [{ cover: "Alertes Instantanées" }, " pour Événements Critiques."] as HeroTitleSegment[],
      // Smoothness
      description:
  ...
  ja: {
    ...
    hero: {
      title: ["重要なイベントに", { cover: "即時アラート" }, "。"] as HeroTitleSegment[],
      description:
  ...
  de: {
    ...
    hero: {
      title: [{ cover: "Sofortige Benachrichtigungen" }, " für kritische Ereignisse."] as HeroTitleSegment[],
      description:
