...
export const supportedLanguages = ["en", "zh", "es", "fr", "ja", "de"] as const;
type SupportedLanguage = (typeof supportedLanguages)[number];

export const tableDimensionLabel: Record<SupportedLanguage, string> = {
  en: "Dimension",
  zh: "维度",
  es: "Dimensión",
  fr: "Critère",
...
export const copy: Record<SupportedLanguage, PageCopy> = {
  en: {
    meta: {
...
export function getCopy(lang: Language): PageCopy {
  return copy[lang as SupportedLanguage] ?? copy.en;
}
