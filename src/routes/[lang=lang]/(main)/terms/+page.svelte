...
<JsonLd
  data={{
    ...
    description: "Terms of Service for Echobell webhook and email notification service",
...
/>
<div
  class="prose dark:prose-invert mx-auto mt-40 mb-20 flex max-w-4xl flex-col p-4 py-8"
>
